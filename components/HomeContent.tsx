    ...
    <main>
        ...
        <Container>
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              ...
              <p className="max-w-2xl text-base leading-relaxed text-slate-300 sm:text-lg">{t.summary}</p>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-4">
                <div className="text-xs font-medium text-slate-400">Highlight</div>
                <div className="mt-1 text-sm font-semibold text-slate-100">1K+ live users</div>
                <div className="mt-1 text-sm text-slate-300">React Native video chat app on AWS + MySQL.</div>
              </div>
              <div className="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-4">
                <div className="text-xs font-medium text-slate-400">Quality</div>
                <div className="mt-1 text-sm font-semibold text-slate-100">85% test coverage</div>
                <div className="mt-1 text-sm text-slate-300">Jest + Pytest for critical modules.</div>
              </div>
              <div className="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-4">
                <div className="text-xs font-medium text-slate-400">Recognition</div>
                <div className="mt-1 text-sm font-semibold text-slate-100">2nd / 95</div>
                <div className="mt-1 text-sm text-slate-300">CSE Demo Day project showcase.</div>
              </div>
            </div>
          </div>
        </Container>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-6">
                ...
                <div className="mt-3 space-y-2 text-sm text-slate-300">
                  <a className="block underline underline-offset-4 hover:text-white" href={SITE.github} target="_blank" rel="noreferrer">
                    GitHub
                  </a>
                  <a className="block underline underline-offset-4 hover:text-white" href={SITE.linkedin} target="_blank" rel="noreferrer">
                    LinkedIn
                  </a>
                  <a className="block underline underline-offset-4 hover:text-white" href={`mailto:${SITE.email}`}>
                    {SITE.email}
                  </a>
                </div>
              </div>
      ...
      <section id="skills" className="scroll-mt-24 py-12">
        <Container>
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-6 shadow-sm">
              <div className="text-sm font-semibold text-slate-100">Primary (this track)</div>
              <div className="mt-4 flex flex-wrap gap-2">
            ...
            <div className="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-6 shadow-sm">
              <div className="text-sm font-semibold text-slate-100">Also comfortable with</div>
              <div className="mt-4 flex flex-wrap gap-2">
                {track === 'aiml'
      ...
      <section id="contact" className="scroll-mt-24 py-12">
        <Container>
          ...
          <div className="mt-6 rounded-2xl border border-slate-800/80 bg-slate-900/70 p-6 shadow-sm">
            <p className="text-sm text-slate-300">{CONTACT.blurb}</p>
